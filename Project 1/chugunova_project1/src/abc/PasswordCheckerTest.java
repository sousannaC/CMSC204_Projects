...
public class PasswordCheckerTest {
	 ...
	 * This test should throw a WeakPasswordException for the given password
	 */
	@Test
	public void testIsWeakPassword() throws WeakPasswordException {
	    try {
	        boolean weakPwd = PasswordCheckerUtility.isWeakPassword("1234@aA");
	        assertTrue("Did not throw WeakPasswordException", weakPwd);
	    } catch (Exception e) {
	        System.out.println(e.getMessage());
	        assertFalse("Threw some incorrect exception", true);
	    }
	}

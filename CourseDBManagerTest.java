...
public class CourseDBManagerTest {
	...
	public void testShowAll() {
	    ...
	    List<String> list = dataMgr.showAll();
	    assertEquals("Course: CMSC204 CRN: 30559 Credits: 4 Instructor: BillyBob Jones Room: SC450", list.get(0));
	    assertEquals("Course: CMSC203 CRN: 30503 Credits: 4 Instructor: Jill B. Who-Dunit Room: SC450", list.get(1));
	    assertEquals("Course: CMSC203 CRN: 30504 Credits: 4 Instructor: Joey Bag-O-Donuts Room: SC450", list.get(2));
	}
	/**
